...
If you're configuring AI2Fin for the first time, pair this guide with the [Quick Start walkthrough](/quickstart) and the [Transaction Management guide](/guides/transaction-management) to see how preferences drive downstream automation.
...
### How do country settings influence GST automation?
Country selection syncs localized tax types and rates so every transaction stores accurate `gstIncluded`, `gstRateUsed`, and `gstAmount` values for reporting.

### Can each user customize AI behavior independently?
Yes. Preferences capture business type, profession, industry, and AI context per user, allowing tailored categorization and tax logic without affecting teammates.

### What if our tax rate changes mid-year?
Updating the rate preserves historical snapshots while applying the new percentage to future transactions, keeping audits and filings consistent.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How do country settings influence GST automation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Country selection syncs localized tax types and rates so every transaction stores accurate gstIncluded, gstRateUsed, and gstAmount values for reporting."
      }
    },
    {
      "@type": "Question",
      "name": "Can each user customize AI behavior independently?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "User profiles capture business type, profession, industry, and AI context per person, enabling tailored categorization and tax logic without affecting teammates."
      }
    },
    {
      "@type": "Question",
      "name": "What if our tax rate changes mid-year?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Updating the rate preserves historical snapshots while applying the new percentage to future transactions, keeping audits and filings consistent."
      }
    }
  ]
}
