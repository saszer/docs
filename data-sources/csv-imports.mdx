...
<Card title="Start Importing" icon="upload" href="https://app.ai2fin.com/all-transactions" horizontal>
Access the All Transactions page to upload your CSV or PDF files.
</Card>
