...
<AccordionGroup>
  <Accordion title="Page Header Section">
    **Top Controls:**
    - **Page Title**: "All Transactions" with total count
    - **Search Bar**: Search by description, amount, merchant
    - **Date Filter**: Select date range for transactions
    - **View Toggle**: Switch between list and categorized views
...
<Columns cols={2}>
  ...
  <Card title="Quick Action Buttons" icon="bolt">
    **Fast Actions:**
    ...
    - **AI Categorize**: Bulk categorization
  </Card>
</Columns>
...
<Columns cols={2}>
  ...
  <Card title="Travel-Specific Navigation" icon="route">
    **Travel Management:**
    ...
    - **Export Reports**: Generate ATO reports
  </Card>
</Columns>
